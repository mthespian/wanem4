...
//***************************************************************************************
function get_current_values($interfaces, &$del, &$delJitter, &$delCorrelation, &$delDistribution, &$loss, &$lossCorrelation, &$dup, &$dupCorrelation, &$reorder, &$reorderCorrelation, &$gap, &$bandwidth, &$corrupt,  &$sym, &$disc, &$limit, &$msFound, &$src, &$srcSub, &$dest, &$destSub, &$port, &$advanced) {
